...
export default function DesktopProfileHeader({
  ...
  return (
    <div ref={profileCardRef} style={{ position: "relative" }}>
      ...
      >
        <Image src={imageSrc} alt={`${name}'s headshot`} fill sizes="360px" placeholder="blur" blurDataURL="data:image/svg+xml;base64,PHN2ZyB4bWxucz0naHR0cDovL3d3dy53My5vcmcvMjAwMC9zdmcnIHdpZHRoPSc0JyBoZWlnaHQ9JzUnPjxyZWN0IHdpZHRoPSc0JyBoZWlnaHQ9JzUnIGZpbGw9JyMyNDExMjMnLz48L3N2Zz4=" priority style={{ objectFit: "cover", objectPosition: "top center" }} />
      </div>
