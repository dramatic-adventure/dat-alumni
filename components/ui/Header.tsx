...
const NAV_ITEMS = [
  ...
  { label: 'STORY MAP', href: '/story-map' },
  {
    ...
    submenu: [
      ...
      // hidden 2026-06: reachable from "Alumni Artists" (/alumni links to /directory)
      { label: 'Alumni Directory', href: '/directory', hidden: true },
    ],
  },
  {
    label: 'PROGRAMS',
    submenu: [
      ...
      { label: 'PASSAGE Projects', href: 'https://www.dramaticadventure.com/passage', external: true },
      { label: 'ACTion Expeditions', href: 'https://www.dramaticadventure.com/action', external: true },
  ...
  },
  {
    ...
    submenu: [
      ...
      { label: 'PLX Programs', href: '/professional-leadership-experience' },
      ...
      // hidden 2026-06: reachable deeper — Join the Team dup of Opportunities Portal; Ambassador via /friends; Propose a Project via /partners
      { label: 'Join the Team', href: '/opportunities', hidden: true },
      { label: 'Join as an Ambassador', href: '/friends/ambassador', hidden: true },
      { label: 'Propose a Project', href: '/partners/propose-project', hidden: true },
    ],
  },
