...
// Frosted-glass field styling (shared with the events editor via glassStyles).
const fieldLabelClass = glassLabelClass;
const fieldInputClass = glassInputClass;
const fieldSelectClass = glassSelectClass;
