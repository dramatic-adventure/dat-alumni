...
const programs = [
  ...
  },
  {
    ...
    desc: "Students develop applied-theatre facilitation skills while leading workshops with youth in partner communities — the core program for faculty-led study abroad groups.",
    length: "3–6 weeks",
    credits: "Credit-eligible",
  },
  {
  ...
  },
  {
    code: "DAT LAB",
    name: "DAT Lab",
    desc: "A research-centered intensive for advanced students, educators, and institutions exploring DAT's pedagogy and community-rooted practice. Can be hosted internationally or brought to your campus.",
    length: "Custom",
    credits: "Negotiable",
  },
];
...
export default function UniversityPartnersPage() {
  return (
    <main style={{ background: "#f6e4c1", overflowX: "hidden" }}>
      ...
      {/* ── HOW IT WORKS ─────────────────────────────────────── */}
      <section style={{ background: "#f6e4c1", padding: "4rem 2rem" }}>
