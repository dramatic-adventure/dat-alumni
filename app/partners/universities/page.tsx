...
const programs = [
  {
    ...
    desc: "DAT's flagship university program. Students live and work inside partner communities — leading theatre workshops with local youth, devising original work, and performing at an international festival. Faculty travel alongside students as co-facilitators or academic supervisors. The full arc: arrive as a student, leave as a teaching artist. Ecuador, Slovakia, and beyond.",
    length: "3–6 weeks",
  ...
  },
  {
    ...
    desc: "A rigorous artist-development intensive for theatre students who want more than a studio. Students train alongside working DAT artists in partner communities abroad — place-based, cross-cultural, and community-rooted. Built for spring break or semester programs. Ecuador, Slovakia, and beyond.",
  ...
  },
  {
    ...
    desc: "A three-week international journey open to students of any arts discipline. Students travel to DAT partner communities, attend professional workshops and international performances, collaborate with local artists, and culminate in a shared performance created from the encounter. No theatre background required.",
    length: "3 weeks",
    credits: "Credit-eligible",
  },
  {
    code: "TREKS",
    name: "Creative Trek",
    desc: "Short, focused cultural immersions built around a specific artistic or academic question. Students pair theatre practice with community observation, storytelling, and exchange. Ideal for doctoral fieldwork, interdisciplinary seminars, or a department's first step into DAT's world.",
    length: "1–3 weeks",
    credits: "Credit-eligible",
  },
  {
  ...
  },
  {
    code: "DAT LAB",
    name: "DAT Lab",
    desc: "A research-centered intensive for advanced students, faculty, and departments exploring DAT's community-rooted pedagogy. Structured around your institution's questions — can be brought to your campus or hosted internationally.",
    length: "Custom",
    credits: "Negotiable",
  },
];
