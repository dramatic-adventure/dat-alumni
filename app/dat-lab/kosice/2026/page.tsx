// app/dat-lab/kosice/2026/page.tsx
// DAT Lab: Košice 2026 — ARCHIVED edition page (EN + SK). Preserves the
// founding edition's recruitment page as it ran; the lab concluded with
// Water That Wanders (/theatre/water-that-wanders) on August 1, 2026.
// Content is the pre-archive page verbatim plus the archive banner only.
...
const copy = {
  en: {
    ...
    archiveNote:
      "Archive — this edition concluded on August 1, 2026. The page is preserved as it ran.",
    archiveCta: "See what's next for DAT Lab: Košice",
  },
  ...
  sk: {
    ...
    archiveNote:
      "Archív — táto edícia sa skončila 1. augusta 2026. Stránku uchovávame v pôvodnej podobe.",
    archiveCta: "Čo je ďalej s DAT Lab: Košice",
  },
} as const;
...
export default function DatLabKosice2026ArchivePage() {
  ...
  return (
    <main className="datlab">
      {/* ---------- Archive banner ---------- */}
      <div className="datlab-archive">
        <div className="datlab-inner">
          <p className="datlab-archive-note">
            {t.archiveNote}{" "}
            <Link href="/dat-lab/kosice" className="datlab-archive-link">
              {t.archiveCta} <span aria-hidden="true">→</span>
            </Link>
          </p>
        </div>
      </div>
      ...
      <style jsx>{`
        ...
        .datlab-archive-note :global(.datlab-archive-link) {
          color: #ffcc00;
          text-decoration: none;
          white-space: nowrap;
        }
        .datlab-archive-note :global(.datlab-archive-link:hover) {
