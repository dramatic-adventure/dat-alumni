...
export const metadata: Metadata = {
  title: "Global Apprenticeship — PLX · Dramatic Adventure Theatre",
  description:
    "DAT's Global Apprenticeship — a 12-week paid intro to arts admin and production for students and recent graduates. Stipend + travel grant included.",
  openGraph: {
    title: "Global Apprenticeship — PLX · DAT",
    description:
      "DAT's Global Apprenticeship — a 12-week paid intro to arts admin and production. Stipend + travel grant included.",
...
const COPY: PlxProgramCopy = {
  ...
  timeline: [
    ...
    { label: "Team Project", detail: "Collaborate with fellow apprentices on a small cohort project." },
