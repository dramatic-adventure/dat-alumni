...
export const metadata: Metadata = {
  title: "Global Apprenticeships — PLX · Dramatic Adventure Theatre",
  description:
    "DAT's Global Apprenticeship — a 10-month paid leadership development program for early-career arts administrators. Stipend + travel grant included.",
  openGraph: {
    title: "Global Apprenticeships — PLX · DAT",
    description:
      "DAT's Global Apprenticeship — a 10-month paid leadership development program for early-career arts administrators.",
    images: ["/images/opportunities/admin-collab.jpg"],
  },
};

const COPY: PlxProgramCopy = {
  programLabel: "Global Apprenticeship",
  heroImage: "/images/opportunities/admin-collab.jpg",
  eyebrow: "Global Apprenticeships",
  ...
  introBody:
    "Through hands-on experience, mentorship, and workshops, Apprentices are given the tools to become impactful leaders. We carefully select one Apprentice each season — someone ready to take real ownership of real work in a global arts organization. The Apprentice serves as a full member of the team, not a stand-in.",
  compensationBullets: [
  ...
  timeline: [
    ...
    { label: "Remote Work · Spring", detail: "Continue your portfolio through June, mentoring incoming interns." },
  ...
  faq: [
    { q: "Is this a full-time job?", a: "No — it's a 20 hrs/wk part-time program. Most apprentices do freelance or part-time work alongside it. We work with you on scheduling." },
    { q: "Is this a path to staff?", a: "Often, yes. Several current DAT staff started as Apprentices. But the goal is your career, not ours." },
    { q: "When does the next cohort open?", a: "One Apprentice per season. Apply by August 1 for the upcoming cohort." },
    { q: "Can international applicants apply?", a: "Yes. We've had Apprentices from Ecuador, Czechia, Tanzania, and the US." },
  ],
  crossLink: { href: "/internships", label: "Internships" },
...
export default async function ApprenticeshipsPage() {
  ...
  const opp = all.find((o) => o.plxProgram === "apprenticeship");
