...
export const productionMap: Record<string, Production> = {
  "water-that-wanders": {
    ...
    artists: {
      ...
      "christen-madrazo": ["Stage Director", "Story Consultant"],
      "barbara-herucova": ["Assistant Stage Director", "Actor"],
      ...
      "jana-stafurova": ["Actor", "Puppeteer"],
  ...
  "nisikilize": {
    ...
    artists: {
      ...
      "claudia-toth": ["Production Stage Manager"],
      "erin-jones": ["Lighting Designer"],
      "elle-kunnos-de-voss": ["Set Designer"],
      "claire-summers": ["Assistant Lighting Designer"],
      "francisco-rondon": ["Assistant Set Designer"],
      "kevin-mcnair":["Production Photographer"],
      "samuel-tapia":["Production Videographer"],
      "jillian-ferry":["Child Wrangler"],
      "andrea-hylen":["Child Wrangler"],
 ...
 "the-cleaver-and-the-wall": {
    ...
    festival: "ACTion Fest 2013: Hearts of Europe",
    url: "",
    posterUrl: "",
    artists: {
      "jason-williamson": ["Director"],
      "christina-watanabe": ["Lighting Designer"],
      "andy-yanni": ["Set Designer"],
      "caity-joy": ["Production Stage Manager"],
      "tiana-brown": ["Assistant Stage Manager"],
      "jaqi-medlock": ["Production Photographer"],
      "jon-campbell": ["Production Videographer"],
      "grace-dowd": ["Lobby Gallery Designer"],
      "drew-ernst": ["Production Assistant"],
      "liz-redington": ["Kraft Services"],
      "petra-slovakova": ["Road Manager"],
      "amber-finn": ["Actor"],
  ...
  "flakes": {
    ...
    artists: {
      ...
      "drew-ernst": ["Production Assistant"],
      "liz-redington": ["Kraft Services"],
      "dominika-siroka": ["Road Manager, Dramaturg"],
      "alexis-floyd": ["Actor"],
...
"a-girl-without-wings-party": {
  ...
  "enchanted-islands": {
    ...
    artists: {
      ...
      "peter-blaine-patagoc": ["Assistant Stage Manager"],
      "brittany-vasta": ["Set Designer"],
      "lauren-rockman": ["Scenic Artist"],
      "drew-florida": ["Lighting Designer"],
      "mady-speigel": ["Production Assistant"],
      "katie-clark": ["Production Assistant"],
      "jon-kevin-lazarus": ["Production Assistant"],
      "russell-vanhorn": ["Assistant Lighting Designer"],
  ...
  "flight-360": {
    ...
    artists: {
      ...
      "santi-baxter": ["Road Manager", "Local Dramaturg"],
      "mary-k-baxter": ["Actor"],
      "jeremy-feldez": ["Actor"],
      "rachel-wiese": ["Actor"],
      "lydia-feldez": ["Actor"],
...
"voices-from-zimbabwe": {
    ...
    year: 2007,
    season: 1,
    location: "Maryland, Pennsylvania, and New York",
    ...
    artists: {
      ...
      "mary-k-baxter": ["Actor"],
      "jesse-baxter": ["Actor"],
      "daniel-chapman": ["Lighting Designer"],
    }
  }
};
