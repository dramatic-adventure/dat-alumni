...
export const season20Events: DatEvent[] = [
...

  {
    ...
    longDescription:
      ...
      "The pieces move between reconciling past and present, the friction and union of meeting across cultures, and the sacred and the mundane of everyday life — water their common thread, image and material both, building toward a spectacle of puppetry and object work.\n\n" +
