...
"dat-lab-kosice-2026": {
  ...
  artists: {
    ...
    "adrian-pica-borjas": ["Writer"],
    "barbora-curejova": ["Actor"],
    "jakub-muransky": ["Actor", "Writer"],
    "jana-stafurova": ["Actor", "Writer"],
    "alica-hingisova": ["Actor", "Writer"],
...
"dat-retreat-berkshires-2023": {
  ...
  artists: {
    ...
    "asa-madrazo-williamson": ["Junior Field Artist"],
    "vida-madrazo-williamson": ["Junior Field Artist"],
    "lucille-baxter": ["Junior Field Artist"],
    "seamus-baxter": ["Junior Field Artist"],
    "greta-amshoff-brenner": ["Junior Field Artist"],
    "isaiah-amshoff-brenner": ["Junior Field Artist"],
  },
},
